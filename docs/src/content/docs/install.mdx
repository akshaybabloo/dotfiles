---
title: Install
description: Instructions to install my dotfiles and scripts.
---

import { Aside } from '@astrojs/starlight/components';

<Aside type="danger" title="Do not run as root!">
...
- Append a small snippet to source the dotfiles main entry (`main.sh`).
...
```sh
# Gollahalli Dotfiles
. "/path/to/cloned/dotfiles/main.sh"
```
